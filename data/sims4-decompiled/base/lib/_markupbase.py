...
# Compiled at: 2013-04-05 23:16:38
...
class ParserBase:
                    ...
                    if c in self._decl_otherchars:
                        ...
                        if c == '[':
                            if decltype == 'doctype':
                                ...
                                if decltype in frozenset({'link', 'linktype', 'attlist', 'element'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            ...
            if sectName in frozenset({'rcdata', 'ignore', 'cdata', 'include', 'temp'}):
                match = _markedsectionclose.search(rawdata, i + 3)
            else:
                if sectName in frozenset({'endif', 'if', 'else'}):
    ...
    def _parse_doctype_subset(self, i, declstartpos):
        ...
        while j < n:
            ...
            if c == '<':
                ...
                if j == -1:
                    return -1
                    if name not in frozenset({'notation', 'attlist', 'entity', 'element'}):
    ...
    def unknown_decl(self, data):
        pass
# okay decompiling data/sims4-not-yet-decompiled/base/lib/_markupbase.pyc
