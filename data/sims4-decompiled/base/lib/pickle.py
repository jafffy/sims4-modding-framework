...
generator_exp ::= load_closure . load_genexpr LOAD_STR MAKE_FUNCTION_2 expr GET_ITER CALL_FUNCTION_1
generator_exp ::= load_closure . load_genexpr LOAD_STR MAKE_FUNCTION_8 expr GET_ITER CALL_FUNCTION_1
generator_exp ::= pos_arg . load_closure load_genexpr LOAD_STR MAKE_FUNCTION_3 expr GET_ITER CALL_FUNCTION_1
generator_exp ::= pos_arg . load_genexpr LOAD_STR MAKE_FUNCTION_3 expr GET_ITER CALL_FUNCTION_1
