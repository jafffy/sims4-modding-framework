...
call ::= expr . pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg pos_arg CALL_FUNCTION_16
call ::= expr CALL_METHOD_0 . 
call ::= expr expr . CALL_METHOD_1
call ::= expr expr . expr CALL_METHOD_2
call ::= expr expr . expr expr CALL_METHOD_3
