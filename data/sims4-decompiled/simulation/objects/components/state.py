...
# Compiled at: 2022-05-26 19:19:47
...
build_class ::= LOAD_BUILD_CLASS mkfunc expr expr expr expr . CALL_FUNCTION_5
build_class ::= LOAD_BUILD_CLASS mkfunc expr expr expr expr CALL_FUNCTION_5 . 
build_class_kw ::= LOAD_BUILD_CLASS . mkfunc expr expr expr expr expr expr LOAD_CONST CALL_FUNCTION_KW_7
build_class_kw ::= LOAD_BUILD_CLASS mkfunc . expr expr expr expr expr expr LOAD_CONST CALL_FUNCTION_KW_7
build_class_kw ::= LOAD_BUILD_CLASS mkfunc expr . expr expr expr expr expr LOAD_CONST CALL_FUNCTION_KW_7
build_class_kw ::= LOAD_BUILD_CLASS mkfunc expr expr . expr expr expr expr LOAD_CONST CALL_FUNCTION_KW_7
build_class_kw ::= LOAD_BUILD_CLASS mkfunc expr expr expr . expr expr expr LOAD_CONST CALL_FUNCTION_KW_7
...
Instruction context:
 ...
 L.1963      1714  LOAD_BUILD_CLASS 
                1716  LOAD_CODE                <code_object ObjectState>
                1718  LOAD_STR                 'ObjectState'
                1720  MAKE_FUNCTION_0          'Neither defaults, keyword-only args, annotations, nor closures'
                1722  LOAD_STR                 'ObjectState'
                1724  LOAD_NAME                HasTunableReference
                1726  LOAD_NAME                ObjectStateValueDisplayMixin
                1728  LOAD_NAME                ObjectStateMetaclass
                1730  LOAD_NAME                get_instance_manager
                1732  LOAD_NAME                sims4
                1734  LOAD_ATTR                resources
                1736  LOAD_ATTR                Types
                1738  LOAD_ATTR                OBJECT_STATE
                1740  CALL_FUNCTION_1       1  '1 positional argument'
                1742  LOAD_CONST               ('metaclass', 'manager')
->              1744  CALL_FUNCTION_KW_6     6  '6 total positional and keyword args'
                1746  STORE_NAME               ObjectState
