...
# Compiled at: 2022-06-02 19:12:10
            ...
            if sim_proto.needs_age_progress_randomized:
                ...
                if hasattr(sim_proto.gameplay_data, 'build_buy_unlock_list'):
                    ...
                    if not (self._primary_aspiration is None or self._primary_aspiration.is_available()):
                        if self.is_human:
                            available_aspirations = self.is_toddler_or_younger or []
...
class AccountConnection(enum.Int, export=False):
    ...
    DIFFERENT_LOT = 2
    OFFLINE = 3
# okay decompiling data/sims4-not-yet-decompiled/simulation/sims/sim_info.pyc
