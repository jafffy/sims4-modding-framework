...
# Compiled at: 2020-06-23 05:47:39
...
class CustomizeObjectMultiPickerInteraction(MultiPickerInteraction):
    ...
    def _create_customize_object(self, customized_obj_info):
        if customized_obj_info is None:
            ...
            return
        return obj
# okay decompiling data/sims4-not-yet-decompiled/simulation/interactions/picker/customize_object_multi_picker_interaction.pyc
